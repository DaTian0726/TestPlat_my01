...
<div class="container" id="content">
    <div class="row">
        ...
        <div class="col-md-9" style="padding: 0px 0px 0px 0px;">
            ...
            <form class="form-horizontal" role="form" style="padding: 20px 0px 0px 0px" action="signquery" method="post">
                ...
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">现在支付签约号</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="mhtContractCode" autocomplete="off" placeholder="请输入该值进行查询！" value="${(signModel.mhtContractCode)!''}"/>
                    </div>
                </div>
                <div class="form-group">
