...
<div class="container" id="content">
    <div class="row">
        ...
        <div class="col-md-9" style="padding: 0px 0px 0px 0px;">
            ...
            <form class="form-horizontal" role="form" style="padding: 20px 0px 0px 0px" action="deductquery" method="post">
                ...
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">交易单号</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="transId" value="${(signModel.transId)!''}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">订单号（与交易号取其一）</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="mhtOrderNo"/>
                    </div>
                </div>
                <div class="form-group">
